...
Plano-mestre que transforma as 4 análises (`analises/`) em frentes de implementação,
...
**Contrato exportado:** documentar eventos/endpoints novos em `analises/contrato-multicamera.md` (para A2 consumir).
...
**Arquivos (novos):** `server/rtsp.sources.json`, `scripts/validate-streams.mjs`, `analises/runbook-demo-cameras.md`.
