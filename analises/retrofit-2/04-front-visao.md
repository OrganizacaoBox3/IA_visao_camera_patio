...
- `CameraWorkspace.tsx:117-151` — **35 linhas** para 4 constantes de cadência. Cada bloco re-narra a fase do
  plano (`P0 + P2 (analises/plano-performance-imagem.md)`, `Fase 0.3 (plano-retrofit-performance)`,
...
`vision/counting.test-notes.md` é documento de notas dentro de `src/` (mover p/ `analises/`).
