...
> Executa o plano `analises/plano-acuracia-modelos.md`. Três frentes de medição (ground truth
> COCO + campo real) respondem às 3 perguntas do dono do produto. Evidência: harness `eval/`
> (committado), `analises/diagnostico-runtime-2026-07.md` (campo), imagens dos erros no
