...
> ADR-003/007/008 (`analises/decisoes/`), `analises/benchmark-interfaces/*`, `analises/plano-padronizacao-visual.md`,
> `analises/auditoria-padroes-ui.md`, `analises/implementacao-changelog.md`, `src/index.css`, `src/tailwind.css`,
> `src/ui/*`, `src/components/AppShell.tsx`, `docs-regenerada/04-frontend-ui-telas.md`, `e2e/app.spec.ts`, `e2e/mobile.spec.ts`.
