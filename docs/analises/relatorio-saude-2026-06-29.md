...
- [ ] Atualizar `docs/arquitetura/` para cobrir Ondas B a G
...
| Sev | Título | Evidência |
|---|---|---|
| P1 | `docs/arquitetura/` desatualizada — Ondas B a G ausentes | AlarmHealth, cineBuffer, tripwires, RBAC, Sparkline sem cobertura |
