...
> `../agentes/exploracao/PRATICAS_ENGENHARIA.md` e `ANALISE_MERCADO_DEV.md` (régua do Akita: arquivos **<500 linhas**, baixa duplicação, verificação automatizada como gargalo) · contexto: `docs/arquitetura/`.
...
- **Eventos socket** emitidos no servidor batem 1:1 com os invariantes de CLAUDE §3 e com `docs/analises/contrato-eventos-alarme.md` / `contrato-multicamera.md`:
...
## 7. Como chegou aqui — dívida do processo de ondas `(I)` (com base em `docs/analises/implementacao-changelog.md` + ADR-001)
