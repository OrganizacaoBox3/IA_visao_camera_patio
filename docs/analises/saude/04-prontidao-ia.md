...
| 8 | **ADRs cobrem decisões não-óbvias** | 🟢 | 7 ADRs + README índice em `docs/analises/decisoes/` (E: ADR-001..007) |
| 9 | **Changelog de implementação** | 🟢 | `docs/analises/implementacao-changelog.md` (E) |
