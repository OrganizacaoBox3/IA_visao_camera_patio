...
>
> Complementa: `docs/produto/manuais/manual-camera-rtsp.md`, `docs/produto/manuais/manual-intelbras-rtsp.md`,
> `docs/analises/contrato-multicamera.md`. Foco aqui: **conectar as câmeras REAIS do CD**.
...
5. **Interprete o status** (evento `camera-status`, ver `docs/analises/contrato-multicamera.md`):
