...
> `docs/analises/decisoes/` e o parecer `docs/analises/auditoria-qualidade-codigo.md` (rubrica de 12
...
2. **Bloco de 8–18 linhas por constante** → destilar para 1–3 linhas de porquê + número.
   Se a explicação longa é medição, ela mora em `docs/analises/` e o comentário aponta o arquivo.
...
**Exceção honesta:** referência a análise/ADR (`docs/analises/perf-input-size-dfine.md`,
