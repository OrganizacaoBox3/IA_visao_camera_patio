...
## 5. Latências conhecidas (`docs/analises/perf-input-size-dfine.md`, tier S, full-set, 8 cores, hub parado)
...
node docs/analises/retrofit-2/baseline-scan.mjs .   # ver script no apêndice; salve-o com este nome
