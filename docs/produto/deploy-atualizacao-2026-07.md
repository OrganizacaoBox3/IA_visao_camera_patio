...
> Runbook da atualização de produção. Complementa `docs/produto/deploy-digitalocean.md` (setup inicial:
...
| **Input configurável** | Default **640** (mantido por evidência — ver `docs/analises/perf-input-size-dfine.md`) | `ANALYSIS_INPUT=512` p/ hub apertado SEM pessoa distante |
...
- [ ] Bancada determinística (opcional, recomendado): MediaMTX na porta **8556** + loop CFTV — ver `docs/analises/plano-teste-camera-real.md` (tier 2, seção HOMOLOG).

### 12.1 Câmeras reais: use o SUB-STREAM como URL de ingest (−60% de CPU do ffmpeg, MEDIDO)

Ganho de **configuração, zero código** (perf round 3, frente 1 — `docs/analises/perf-round3/frente1-ingest-relay.md`
