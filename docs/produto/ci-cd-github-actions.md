...
> `docs/produto/deploy-atualizacao-2026-07.md`; o setup **inicial** do servidor continua sendo
> `docs/produto/deploy-digitalocean.md` (o CD atualiza uma instalação existente, não faz bootstrap).
...
- [ ] `/var/www/visao-patio` existe (setup inicial: `docs/produto/deploy-digitalocean.md`);
...
É o §9 do `docs/produto/deploy-atualizacao-2026-07.md`. O log do run que falhou imprime o
...
|---|---|---|
| VPS sem o setup inicial | pré-checagem falha: `"/var/www/visao-patio não existe"` / `"unit visao-hub não instalada"` | Rodar `docs/produto/deploy-digitalocean.md` uma vez, manualmente. |
