...
pedestres — foi exatamente o caso do diagnóstico de jul/2026 (`docs/analises/diagnostico-runtime-2026-07.md`).
...
Para **cenas industriais reais** de demonstração (portos etc.), veja o catálogo em `docs/analises/cameras-industriais/00-guia.md` (com as ressalvas: YouTube expira, EarthCam/Skyline proíbem extração dos sites deles, trânsito BR é snapshot).
