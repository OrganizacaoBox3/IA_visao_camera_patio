...
|---|---|---|---|
| A1 | **Set-membership: anel BLE ∩ setor câmera ∩ navegável** — "região garantida, não aposta" | caderno §3; base.md:183,342 | 🟡 **anel entregue hoje** (`floor-plot.ts` + plotagem no monitoramento); falta ∩ setor da câmera e ∩ navegável (polígono de chão) |
