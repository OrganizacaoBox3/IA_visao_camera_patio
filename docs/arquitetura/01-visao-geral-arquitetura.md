...
- **Análise de indicadores no hub; navegador = espelho (ADR-009, jul/2026):** a detecção
  ...
  `docs/analises/decisoes/ADR-009-analise-server-side.md`.
...
├── docs/produto/                       Documentação ORIGINAL (não tocar) — planos, manuais, avaliações
├── docs/arquitetura/            Documentação regenerada (este arquivo)
