...
//   • enabled=true  → carrega já e re-carrega a cada ~1s (a aplicação ESPERA refresh dos beacons a
//     cada ~1s — pedido do dono 2026-07-15, pós-reconfiguração das tags p/ advertising rápido; o
//     ingest no hub é ~500ms, então 1s de poll entrega dado fresco sem marretar a API).
