    ...
    <div className="shell">
      ...
      <nav className="rail" aria-label="Navegação principal">
        ...
        <NavLink to="/" end className={item}>
          ...
          <span className="ri-lb">Central</span>
        </NavLink>
        <NavLink to="/relatorio" className={item}>
          <span className="ri-ic" aria-hidden>
            📊
          </span>
          <span className="ri-lb">Relatório</span>
        </NavLink>
        {canConfigure && (
          <NavLink to="/alarmes-saude" className={item}>
            <span className="ri-ic" aria-hidden>
              🔔
            </span>
            <span className="ri-lb">Saúde alarmes</span>
          </NavLink>
        )}
        {user.papel === "superadmin" && (
          <NavLink to="/usuarios" className={item}>
            ...
            <span className="ri-lb">Usuários</span>
          </NavLink>
        )}
        <NavLink to="/perfil" className={item}>
          ...
          <span className="ri-lb">Meu perfil</span>
        </NavLink>
        ...
        <Tooltip content="Sair (encerrar acesso)">
          <button className="rail-item" onClick={() => logout()}>
            ...
            <span className="ri-lb">Sair</span>
          </button>
        </Tooltip>
