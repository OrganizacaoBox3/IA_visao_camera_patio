/* eslint-disable */
/*
 * Vendored from go2rtc (AlexxIT/go2rtc) — www/video-stream.js, v1.6.0. License: Apache-2.0.
 * Self-hosted (sem CDN) p/ respeitar CSP script-src 'self'. Não editar (exceto este cabeçalho).
 * Fonte: https://github.com/AlexxIT/go2rtc/tree/master/www
 */
