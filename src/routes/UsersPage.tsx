        ...
        >
          <TabsContent value="cameras">
            <section className="panel">
              ...
              {enrollUrl ? (
                ...
                <p className="meta-text muted">
                  Defina <code>CAMERA_TOKEN</code> no hub (systemd) para gerar o link de
                  enrolamento. Sem ele, a câmera usa a sessão de um usuário logado no mesmo
                  navegador.
                </p>
              )}
            </section>
          ...
          <TabsContent value="notificacoes">
            <section className="panel">
              ...
              {!wa || !wa.enabled ? (
                <p className="meta-text muted">
                  Desligado. Defina <code>WHATSAPP_ENABLED=1</code> no hub (systemd) e pareie aqui.
                  Use um número dedicado (Baileys é não-oficial).
                </p>
              ) : wa.connected ? (
                <div className="wa-conn">
                  <p className="meta-text">
                    <b style={{ color: "var(--ok)" }}>Conectado.</b> Os alertas elegíveis serão
                    enviados aos usuários com WhatsApp ativo.
                  </p>
            ...
            <section className="panel">
              ...
              <p className="meta-text muted">
                Números avulsos que recebem os alertas (além dos usuários que cadastram o próprio
                número em "Meu perfil"). Você é responsável pelo consentimento (LGPD).
              </p>
